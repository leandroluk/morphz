...
- [2026-08-28] `v0.2.0` RELEASED. `release.yml` ran green end-to-end (all 6
  ...
  Release created, CHANGELOG regenerated by git-cliff `--bump` (0.1.0 →
  0.2.0 from the `feat!`) and committed back to `main`.
- [2026-08-28] Docs: added editor-extension coverage — `docs/README.md`
  "Editor support" section (extension vs `tsconfig.json`, editor matrix),
  `docs/guides/editor-tooling.md` "Editor extensions" section (both
  registries, activation-layer explanation, requirements, status bar).
